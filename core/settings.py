...
SECRET_KEY = os.environ.get('SECRET_KEY', 'ppiieettrroodjango')
...
'feed.middleware.BloqueioPorIPMiddleware',

'feed.middleware.BloqueioSustentacaoMiddleware',
...
'feed.context_processors.alerta_sistema',
            ],
        },
    },
]
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get(
            'DATABASE_URL',
            'postgresql://postgres.xaxaolfbclnqitftepwa:ppiieettrroo@aws-1-us-west-2.pooler.supabase.com:6543/postgres'
        ),
        conn_max_age=600,
        ssl_require=True,
    )
...
EMAIL_HOST_PASSWORD = 'aquela_senha_de_16_digitos_do_google'
DEFAULT_FROM_EMAIL = f'Nome da Sua Rede <{EMAIL_HOST_USER}>'
