...
urlpatterns = [
    ...
    path('story/novo/', views.criar_story, name='criar_story'),
    path('story/<int:story_id>/visto/', views.story_marcar_visto, name='story_marcar_visto'),
    path('story/<str:username>/', views.story_ver, name='story_ver'),
]
